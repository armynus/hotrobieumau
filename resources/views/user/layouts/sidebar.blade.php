<ul class="navbar-nav  sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #ae1c3f; 
    background-size: cover;">
            ...
            {{-- ===== VĂN THƯ ===== --}}
            <li class="nav-item {{ request()->routeIs('documents_forward', 'view_data_account') ? 'active' : '' }}">
                <a class="nav-link {{ request()->routeIs('documents_forward', 'view_data_account') ? '' : 'collapsed' }}"
                href="#" data-toggle="collapse" data-target="#collapseOne"
                aria-expanded="{{ request()->routeIs('documents_forward', 'view_data_account') ? 'true' : 'false' }}"
                aria-controls="collapseOne">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-database-fill" viewBox="0 0 16 16">
                        <path d="M3.904 1.777C4.978 1.289 6.427 1 8 1s3.022.289 4.096.777C13.125 2.245 14 2.993 14 4s-.875 1.755-1.904 2.223C11.022 6.711 9.573 7 8 7s-3.022-.289-4.096-.777C2.875 5.755 2 5.007 2 4s.875-1.755 1.904-2.223"/>
                        <path d="M2 6.161V7c0 1.007.875 1.755 1.904 2.223C4.978 9.71 6.427 10 8 10s3.022-.289 4.096-.777C13.125 8.755 14 8.007 14 7v-.839c-.457.432-1.004.751-1.49.972C11.278 7.693 9.682 8 8 8s-3.278-.307-4.51-.867c-.486-.22-1.033-.54-1.49-.972"/>
                ...
                <div id="collapseOne"
                    class="collapse @menuOpen('documents_forward', 'view_data_account')"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item @active('documents_forward')"
                        href="{{ route('documents_forward') }}">Văn bản TỈNH</a>
                        <a class="collapse-item @active('view_data_account')"
                        href="{{ route('view_data_account') }}">Sổ văn bản</a>
                    </div>
                </div>
            </li>
