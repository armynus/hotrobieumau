<ul class="navbar-nav  sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #ae1c3f; 
    background-size: cover;">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseFormType"
                    aria-expanded="true" aria-controls="collapseFormType">
                ...
                <div id="collapseFormType" class="collapse" aria-labelledby="headingForm" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{route('admin_form_type')}}">Thể loại biểu mẫu</a>
                        <a class="collapse-item" href="{{route('admin_sup_form_type')}}">Thể loại phụ biểu mẫu</a>
                    </div>
                </div>
            </li>
